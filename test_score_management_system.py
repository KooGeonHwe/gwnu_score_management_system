...
class TestScoreManagementSystem(unittest.TestCase):
    ...
    def setUp(self):
        self.m_open = mock_open(read_data="2019,구건회,90,80,70\n2012,다비드비야,90,90,90\n2015,토레스,80,80,80")
    ...
    def test_sort_1(self):
        with patch('score_management_system.open', self.m_open):
            ...
            self.assertEqual('1,2019,구건회,90,80,70,240,80\n2,2012,다비드비야,90,90,90,270,90\n3,2015,토레스,80,80,80,240,80', result)
    ...
    def test_sort_3(self):
        with patch('score_management_system.open', self.m_open):
            ...
            self.assertEqual('3,2015,토레스,80,80,80,240,80\n2,2012,다비드비야,90,90,90,270,90\n1,2019,구건회,90,80,70,240,80', result)
    ...
    def test_sort_4(self):      
        with patch('score_management_system.open', self.m_open):
            ...
            self.assertEqual('1,2019,구건회,90,80,70,240,80\n3,2015,토레스,80,80,80,240,80\n2,2012,다비드비야,90,90,90,270,90', result)
    ...
    def test_sort_5(self):      
        with patch('score_management_system.open', self.m_open):
            ...
            self.assertEqual('2,2012,다비드비야,90,90,90,270,90\n1,2019,구건회,90,80,70,240,80\n3,2015,토레스,80,80,80,240,80', result)
    ...
    def test_write_1(self):
        ...
        self.m_w.write.assert_called_with("1,2019,구건회,90,80,70,240,80\n2,2012,다비드비야,90,90,90,270,90\n3,2015,토레스,80,80,80,240,80")
    ...
    def test_write_2(self):
        ...
        self.m_w.write.assert_called_with("3,2015,토레스,80,80,80,240,80\n2,2012,다비드비야,90,90,90,270,90\n1,2019,구건회,90,80,70,240,80")
    ...
    def test_write_4(self):
        ...
        self.m_w.write.assert_called_with("2,2012,다비드비야,90,90,90,270,90\n1,2019,구건회,90,80,70,240,80\n3,2015,토레스,80,80,80,240,80")
